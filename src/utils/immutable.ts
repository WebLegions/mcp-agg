...
export class Immutable extends Object {
    ...
    static parseValidate<S extends Validator<unknown>>(
        validator: S,
        text: string | SharedArrayBuffer | ArrayBuffer,
        reviver: typeof reviverFn = reviverFn,
    ): Readonly<Infer<S>> {
        ...
        return Object.freeze(value) as Readonly<Infer<S>>;
    }

    /** Safe version of parseValidate - returns [data, undefined] or [undefined, error] */
    static safeParseValidate<S extends Validator>(
        validator: S,
        text: string | SharedArrayBuffer | ArrayBuffer,
        reviver: typeof reviverFn = reviverFn,
    ): [Readonly<Infer<S>>, undefined] | [undefined, Error] {
        return safeSync(() => Immutable.parseValidate(validator, text, reviver));
    }
