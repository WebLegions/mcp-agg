...
const defOpts = (_t: test.TestContext) => ({ includeSchemaVersion: false });
...
describe('Validator Schema', () => {
    ...
    test('should import and validate MCP server schema', async () => {
    ...
    test('should validate MCP Tool definition', async () => {
        const fs = await import('node:fs/promises');
        const path = await import('node:path');
        const { fileURLToPath } = await import('node:url');
    ...
    test('should validate MCP Resource definition', async () => {
        const fs = await import('node:fs/promises');
        const path = await import('node:path');
        const { fileURLToPath } = await import('node:url');
